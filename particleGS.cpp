...
void ParticleGS::Init()
{
	...
	Renderer::CreateComputeShader(&m_ComputeShader, "shader\\particleCSGS.cso");
	...
	Renderer::CreateVertexShader(&m_VertexShader, &m_VertexLayout, "shader\\particleVSGS.cso");

	Renderer::CreatePixelShader(&m_PixelShader, "shader\\particlePS.cso");
}

void ParticleGS::Uninit()
{
