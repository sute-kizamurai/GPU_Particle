...
void ParticleShootingMethodImgui::Init()
{
	...
	m_ShootingMethod[1] = { 1.0f, 0.0f };
	m_ShootingMethod[2] = { 0.0f, 0.0f };
	m_ShootingMethod[3] = { 0.5f, -0.5f };
...
{
	//発射方法の文字をまとめた配列
	const char* items[] = { "Sphere", "Hemisphere", "Ring", "Fountain" };
	...
	{
		m_Target->SetShootingMethod(m_ShootingMethod[item_current]);
	}
}
